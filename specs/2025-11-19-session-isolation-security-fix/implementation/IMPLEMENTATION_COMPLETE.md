...
- `VERCEL_AUTH_SETUP.md` - Vercel deployment guide
...
- `SESSION_MONITORING.md` - SQL monitoring queries guide
- `SESSION_EMERGENCY_CLEANUP.md` - Emergency response procedures
- `MANUAL_SESSION_TEST.md` - Manual testing guide
...
**Documentation:**
4. `VERCEL_AUTH_SETUP.md` (Deployment guide)
5. `SESSION_MONITORING.md` (SQL queries & monitoring)
6. `SESSION_EMERGENCY_CLEANUP.md` (Emergency procedures)
7. `MANUAL_SESSION_TEST.md` (Manual testing guide)
...
**Spec Documentation:**
10. `specs/2025-11-19-session-isolation-security-fix/` (Complete spec)
...
6. `specs/.../tasks.md` - Task tracking
7. `specs/.../implementation/PROGRESS.md` - Progress tracking
...
- [ ] Run manual session test (see `MANUAL_SESSION_TEST.md`)
...
Follow complete procedure in `MANUAL_SESSION_TEST.md`:
...
1. **IMMEDIATE:** Execute `SESSION_EMERGENCY_CLEANUP.md` Procedure 1
2. Notify team lead
...
**Created in this fix:**
- `VERCEL_AUTH_SETUP.md` - Vercel environment setup
- `SESSION_MONITORING.md` - SQL queries and monitoring
- `SESSION_EMERGENCY_CLEANUP.md` - Emergency procedures
- `MANUAL_SESSION_TEST.md` - Manual testing guide

**Existing documentation:**
- `agent-os/product/tech-stack.md` - Tech stack overview
- `specs/2025-11-18-security-foundation/` - Original security spec
