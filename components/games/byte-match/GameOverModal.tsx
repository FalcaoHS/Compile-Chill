...
export function GameOverModal({ isOpen, score, moves, duration, bestScore, onPlayAgain }: GameOverModalProps) {
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="text-xl font-bold text-text font-theme">
                        {moves}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="text-xl font-bold text-accent font-theme">
                        {formatTime(duration)}
                      </div>
                    </div>
                  </div>
