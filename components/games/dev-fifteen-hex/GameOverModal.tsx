            ...
            >
              <div className="text-center space-y-6">
                <motion.h2
                  ...
                  className="text-3xl sm:text-4xl font-bold text-text font-theme"
                >
                  MEMORY DEFRAGMENTED!
                </motion.h2>
                ...
                {isEasterEgg && (
                  <motion.div
                    ...
                    "
                  >
                    <div className="text-lg mb-2">🟣 Overclock detectado!</div>
                    <div className="text-sm">
                      Você desbloqueou um emote lendário: 0xFF — Memory Overclock
                    </div>
                  </motion.div>
                )}
