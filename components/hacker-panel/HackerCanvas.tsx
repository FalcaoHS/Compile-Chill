...
function getThemeColors(themeId: ThemeId) {
  ...
  return {
    bg: computedStyle.getPropertyValue('--color-bg').trim() || '#070912',
    bgSecondary: computedStyle.getPropertyValue('--color-bg-secondary').trim() || '#0a0f1a',
    primary: computedStyle.getPropertyValue('--color-primary').trim() || '#7ef9ff',
    accent: computedStyle.getPropertyValue('--color-accent').trim() || '#7dd3fc',
  }
}
