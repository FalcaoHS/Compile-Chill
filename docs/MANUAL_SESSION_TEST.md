...
5. Review recent changes to:
   ...
   - `lib/auth-adapter.ts`
   - `middleware.ts`
6. Consult `docs/SESSION_EMERGENCY_CLEANUP.md` if session leakage detected
...
- Check: `docs/SESSION_MONITORING.md` for monitoring queries
- Check: `docs/SESSION_EMERGENCY_CLEANUP.md` for emergency procedures
